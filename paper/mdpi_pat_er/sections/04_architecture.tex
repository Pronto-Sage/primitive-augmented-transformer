...
Each primitive head answers a characteristic question:
...
This question view is not only interpretive. It determines the labels and losses
attached to each head: primitive class, support status, entailment state,
role-to-primitive mapping, verifier likelihood, evidence pointer, IDK action,
