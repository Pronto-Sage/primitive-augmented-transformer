...
The strongest support is B versus C. Both conditions share the same Qwen3-0.6B
backbone and data. B has access to labels through token-pooled auxiliary heads.
C has the PAT-ER side-state. The consistent B/C gap means that the register
architecture contributes beyond label availability.
